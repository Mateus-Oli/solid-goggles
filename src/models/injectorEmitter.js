...
export class InjectorEmitter {
  ...
  remove(e, i, l) {
    ...
    this.listeners = this.listeners.filter(({ event, implementation, listener }) => e !== event || i !== implementation || l !== listener);

    return oldListeners.length === this.listeners.length ? undefined : l;
  }
